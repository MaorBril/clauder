...
func TestInstance_Lifecycle(t *testing.T) {
	...
	// Register
	err := store.RegisterInstance("test-instance-id", 12345, "/test/dir", "testhash", "/dev/ttys000")
	if err != nil {
...
func TestInstance_Cleanup(t *testing.T) {
	...
	_ = store.RegisterInstance("old-instance", 111, "/old", "oldhash", "")
	_ = store.RegisterInstance("new-instance", 222, "/new", "newhash", "")
...
func TestMessage_SendAndReceive(t *testing.T) {
	...
	// Setup instances
	_ = store.RegisterInstance("sender", 1, "/sender", "senderhash", "")
	_ = store.RegisterInstance("receiver", 2, "/receiver", "receiverhash", "")
